...
function sort(countries: InstructorListModel[], column: SortColumn, direction: string): InstructorListModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
function matches(country: InstructorListModel, term: string, pipe: PipeTransform) {
...
export class InstructorListService {
  ...
  private _countries$ = new BehaviorSubject<InstructorListModel[]>([]);
  ...
  constructor(private pipe: DecimalPipe) {
    ...
    this.products = instructorList.reverse();
  }
