...
function sort(countries: sellerModel[]): sellerModel[] {
    return countries;
}

function matches(country: sellerModel, term: string, pipe: PipeTransform) {
  return country.name.toLowerCase().includes(term.toLowerCase())
    || country.seller.toLowerCase().includes(term.toLowerCase())
    ...
    || country.revenue.toLowerCase().includes(term.toLowerCase())
    ;
}
