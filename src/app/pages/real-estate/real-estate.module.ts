...
import { NgbdEstateListSortableHeader } from './grid/grid-sortable.directive';
...
import { NgbdEarningSortableHeader } from './earnings/earnings-sortable.directive';
...
@NgModule({
  declarations: [
    GridComponent,
    NgbdEstateListSortableHeader,
    ListComponent,
    MapComponent,
    PropertyOverviewComponent,
    AddPropertiesComponent,
    EarningsComponent,
    NgbdEarningSortableHeader
  ],
  imports: [
    CommonModule,
