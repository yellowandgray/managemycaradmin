...
export class AreaComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._splineAreaChart('["--tb-primary", "--tb-secondary"]');
    this._datetimeXaxisChart('["--tb-info"]');
    this._nagativeValueChart('["--tb-success", "--tb-info"]');
    this._githubmMonthAreaChart('["--tb-danger"]');
    this._githubmYearAreaChart('["--tb-success"]');
    this._stackedAreaChart('["--tb-success", "--tb-info", "--tb-light"]');
    this._irregularTimeseriesChart('["--tb-primary", "--tb-warning", "--tb-success"]');
    this._nullValuesAreaChart('["--tb-success"]');
  }
 ...
 * X-Axis-Area Chart
 */
  private _datetimeXaxisChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.datetimeXaxisChart = {
      series: [
        {
          data: data
        }
 ...
 */
  private _nagativeValueChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.nagativeValueChart = {
      series: [
        {
          name: "North",
          data: [
...
*/
  private _githubmMonthAreaChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.githubmMonthAreaChart = {
      series: [
        {
          name: "commits",
 ...
 */
  private _githubmYearAreaChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.githubmYearAreaChart = {
      series: [
        {
          name: "commits",
          data: githubData.series
 ...
 */
  private generateDataSets(t: number) {
  ...
  private _irregularTimeseriesChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.irregularTimeseriesChart = {
      series: [
        {
          name: "PRODUCT A",
...
*/
  private _nullValuesAreaChart(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.nullValuesAreaChart = {
      series: [
        {
          name: "Network",
          data: [
