...
export class CandlestickComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicCandlestickChart('["--tb-success", "--tb-danger"]');
    this._chartCandleOptions('["--tb-info", "--tb-danger"]');
    this._chartBarOptions('["--tb-warning", "--tb-danger"]');
    this._categoryXAxisChart('["--tb-success", "--tb-danger"]');
    this._candlestickLineChart('["--tb-success", "--tb-danger", "--tb-info", "--tb-warning"]');
  }
