...
import { SortColumn, SortDirection } from './crm-sortable.directive';
...
function sort(countries: leadModel[], column: SortColumn, direction: string): leadModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
export class CRMService {
  ...
  private _countries$ = new BehaviorSubject<leadModel[]>([]);
