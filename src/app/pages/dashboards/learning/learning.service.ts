...
import { SortColumn, SortDirection } from './learning-sortable.directive';

interface SearchResult {
  countries: CourseModel[];
  total: number;
}
...
function sort(countries: CourseModel[], column: SortColumn, direction: string): CourseModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
export class LearningService {
  ...
  private _countries$ = new BehaviorSubject<CourseModel[]>([]);
