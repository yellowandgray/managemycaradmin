...
import { SortColumn, SortDirection } from './real-estate-sortable.directive';

interface SearchResult {
  countries: PropertyModel[];
  total: number;
}
...
function sort(countries: PropertyModel[], column: SortColumn, direction: string): PropertyModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
export class RealEstateService {
  ...
  private _countries$ = new BehaviorSubject<PropertyModel[]>([]);
